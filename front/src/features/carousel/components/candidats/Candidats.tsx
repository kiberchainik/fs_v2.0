...
export default function Candidats() {
    ...
    return (
        <div className="w-screen flex flex-col md:flex-row bg-[#cee5ec] -ml-5 gap-20 my-20 md:h-[450px] items-center">
            <div className="flex flex-col gap-2 w-full md:w-[40%] bg-[#b1dbe9] p-10 h-full items-center justify-center">
