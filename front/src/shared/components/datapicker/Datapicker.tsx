...
import { Button, buttonVariants, Popover, PopoverContent, PopoverTrigger, ScrollArea } from '@/shared/components/ui'
...
export function DateTimePicker({
  ...
  const dislayFormat = useMemo(() => {
    ...
    return format(
      displayValue ? displayValue : new Date().toISOString(),
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        {renderTrigger ? (
          ...
          <div
            className={cn(
              'flex w-full cursor-pointer items-center h-10 ps-3 pe-1 font-normal border border-input rounded-full text-sm shadow-sm',
