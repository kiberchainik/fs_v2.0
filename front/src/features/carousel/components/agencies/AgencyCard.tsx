...
import { Button, CarouselItem, Description } from "@/shared/components"
...
export const AgencyCard: FC<ICarouselAgencies> = ({ agency_name, logo, slug, user, url, about }) => {
    return (
        <CarouselItem key={slug}>
            <div className="flex flex-col items-center gap-y-3 bg-white dark:bg-neutral-800 p-5 rounded-3xl w-[350px]">
