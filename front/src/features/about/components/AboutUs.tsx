            ...
            <section className="mx-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20 border-b-2 items-center border-neutral-200 border-dashed pb-10 mb-10">
                    <div className="flex flex-col gap-2">
                        ...
                        <h3 className="mb-5 pb-5 text-5xl leading-[4rem] font-semibold text-[#17233e]">{t('title_h3')}</h3>
                        <p className="mb-2"><b>{t('desc_title_p1')}</b>: {t('desc_p1')}</p>
                        <p className="mb-2"><b>{t('desc_title_p2')}</b>: {t('desc_p2')}</p>
                        <p className="mb-2"><b>{t('desc_title_p3')}</b>: {t('desc_p3')}</p>
                        <p className="mb-2"><b>{t('desc_title_p4')}</b>: {t('desc_p4')}</p>
                        <p className="mb-2"><b>{t('desc_title_p5')}</b>: {t('desc_p5')}</p>
                        <p className="mb-2"><b>{t('desc_title_p6')}</b>: {t('desc_p6')}</p>
